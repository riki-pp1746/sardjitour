...
export default function App() {
  ...
  const fetchUserManagementData = async () => {
    ...
    try {
      ...
      console.error("[UR Sardjito] Error fetching user management data:", err);
    ...
    return (
      <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-12">
        <SectionHeader 
          ...
          desc="Otorisasi pengajuan akun baru dan atur masa aktif akses UR Sardjito langsung dari aplikasi secara otomatis." 
        ...
        <Card className="p-6">
          <div className="border-b border-slate-100 pb-4 mb-4 flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-slate-500 font-medium">Berikut adalah semua akun yang saat ini terdaftar dan memiliki akses masuk ke UR Sardjito.</p>
            </div>
        ...
        <Card className="p-6">
          ...
          <div className="space-y-4 text-xs font-bold text-slate-700 leading-relaxed">
            ...
            <div className="flex gap-3">
              ...
              <p>Pilih tipe deployment **Web App**. Pada pilihan **Execute as**, pilih **Me (Email Anda)**. Pada pilihan **Who has access**, pilih **Anyone** (Siapa saja, bahkan anonim - tenang saja, ini aman karena hanya diakses oleh aplikasi UR Sardjito Anda).</p>
            </div>
            <div className="flex gap-3">
  ...
  if (action === "reject") {
    ...
    if (email) {
      try {
        ...
        var htmlBody = "<div style='font-family: Arial, sans-serif; padding: 20px; color: #333; max-width: 600px; border: 1px solid #e2e8f0; border-radius: 12px;'>" +
                       "  <h2 style='color: #ef4444;'>Status Pengajuan Akun UR Sardjito</h2>" +
                       "  <p>Yth. <strong>" + picName + "</strong>,</p>" +
  ...
  if (action === "forgot_password") {
    ...
    if (found && email) {
      try {
        ...
        var htmlBody = "<div style='font-family: Arial, sans-serif; padding: 20px; color: #333; max-width: 600px; border: 1px solid #e2e8f0; border-radius: 12px;'>" +
                       "  <h2 style='color: #0ea5e9;'>Pemulihan Kredensial Akun UR Sardjito</h2>" +
                       "  <p>Yth. <strong>" + picName + "</strong>,</p>" +
